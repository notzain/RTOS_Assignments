...
set(AVR_DEFAULT_MCU     "atmega2560"   CACHE STRING "The AVR MCU to use when configuring the build for the first time")
...
function(ADD_AVR_FIRMWARE exec_target)
  ...
  if (AVRDUDE_BIN)
    add_custom_target(upload_${exec_target}
      sudo avrdude -v -p ${AVR_MCU} -c ${AVRDUDE_PROGRAMMER} -P ${AVRDUDE_PORT} -b 115200 -D -U flash:w:${hex_file}:i
      DEPENDS ${hex_file}
